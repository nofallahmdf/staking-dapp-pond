...
!(function () {
  ...
  async function i({ type: i, data: o, options: a }) {
    ...
    let s = u.includes(location.host),
      f = {
        ...
        ...('event' === i && o && { en: o.name, ed: o.data }),
      };
    try {
      await fetch(`${n}/${'pageview' === i ? 'view' : 'event'}`, { method: 'POST', keepalive: !0, headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(f) });
    } catch (h) {}
  }
  async function o(e = {}) {
  ...
  async function a(e, t) {
    return i({ type: 'event', data: { name: e, data: t }, options: { withReferrer: !0 } });
  }
  function r(e) {
  ...
  (() => {
    ...
    (window.vai = !0), u(), o({ withReferrer: !0 });
    let e = history.pushState.bind(history);
    (history.pushState = function (...t) {
      e(...t), l(t[2]), (d = location.href);
    }),
      window.addEventListener('popstate', function () {
        l(location.href), (d = location.href);
      });
  })();
})();
